...
public class UI_ToolTip : MonoBehaviour
{
    ...
    public virtual void ShowToolTip(bool show, RectTransform targetRect)
    {
        ...
        UpdatePoition(targetRect);
    }

    private void UpdatePoition(RectTransform targetRect)
    {
        float screenCenterX = Screen.width / 2f;
        float screenTop = Screen.height;
        float screenBotton = 0;
        ...
        else if (bottomY < screenBotton)
            targetPosition.y = screenBotton + verticalHalf + offset.y;
